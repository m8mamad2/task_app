...
class _ChangeProfileImageScreenState extends State<ChangeProfileImageScreen> {
  ...
  void initState() {
    super.initState();
    selected = widget.profileNumber! + 1;
  }
          ...
          children: [
            ...
            SizedBox(
              ...
              child: CircleAvatar( 
                ...
                backgroundImage: AssetImage(finalImage(selected + 1)),
                backgroundColor: kMainColor,),
            ),
        
            Padding(
              padding:  EdgeInsets.only(top: kheight(context)*0.04,bottom: kheight(context)*0.03),
              child: Text('Please Chosee a Image of Blow :',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: kwidth(context)*0.04),),
            ),
